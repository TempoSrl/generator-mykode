...
-- Non eseguo l'inserimento per idmenuweb = 4 poiché è commentato
...
-- Inserimento dati in web_listredir
INSERT INTO web_listredir (tablename, listtype, newtablename, newlisttype, ct, cu, lt, lu)
VALUES ('mandate', 'on_view', 'mandateview', 'default', SYSDATE, 'nino', SYSDATE, 'nino');
...
BEGIN
  ...
  IF v_table_exists = 0 THEN
    EXECUTE IMMEDIATE 'CREATE TABLE MANDATE (
        idmankind VARCHAR2(20) NOT NULL,
        yman NUMBER(5) NOT NULL,
        nman NUMBER(10) NOT NULL,
        active CHAR(1),
        adate DATE NOT NULL,
...
-- Cancello i dati dalla tabella MANDATE
DELETE FROM MANDATE;
...
DECLARE
  v_table_exists_kind NUMBER;
BEGIN
  SELECT COUNT(*)
  INTO v_table_exists_kind
  FROM user_tables
  WHERE table_name = 'MANDATEKIND';

  IF v_table_exists_kind = 0 THEN
    EXECUTE IMMEDIATE 'CREATE TABLE MANDATEKIND (
        idmankind VARCHAR2(20) NOT NULL,
        active CHAR(1),
        description VARCHAR2(150) NOT NULL,
        header VARCHAR2(150),
...
-- Cancello i dati dalla tabella MANDATEKIND
...
VALUES ('CICCIO-CP', 'S', TIMESTAMP '2013-03-12 10:24:04.593', 'sa',
        'Contratto Ciccio', 'BL0001', TIMESTAMP '2018-02-08 12:22:35.623', 'assistenza');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('CICCIO-CP_PCC', 'S', TIMESTAMP '2013-03-12 10:24:04.593', 'sa',
        'Contratto CP_PCC', 'BL0002', TIMESTAMP '2018-02-08 12:22:35.623', 'assistenza');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('CP_PCC', 'S', TIMESTAMP '2014-12-30 15:54:59.757', 'assistenza',
        'Documento equivalente di pagamento', '123456', TIMESTAMP '2019-09-03 16:15:19.927', 'nino');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('GENERALE', 'S', TIMESTAMP '2006-01-31 17:12:09.953', 'sa',
        'Tipo ordine GENERALE', 'Intestazione da mandatekind.', TIMESTAMP '2023-06-07 12:43:03.250', 'assistenza');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('GIURprova', 'S', TIMESTAMP '2015-09-03 16:30:43.140', 'assistenza',
        'GIUR - Convenzione passiva (Non soggetta ad IVA)', NULL, TIMESTAMP '2018-02-12 17:37:44.830', 'assistenza');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('NOFATT', 'S', TIMESTAMP '2010-03-22 09:35:53.937', 'SARA',
        'Contratto Passivo  collegabile a Fattura', '86', TIMESTAMP '2016-06-01 14:13:03.877', 'assistenza');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('NOFATTURA', 'S', TIMESTAMP '2010-06-25 16:06:41.547', 'SA',
        'Contratto passivo SENZA FATTURA', '4', TIMESTAMP '2010-10-15 13:10:04.573', 'sa');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('PRIMO', 'S', TIMESTAMP '2006-08-03 10:47:12.703', 'sa',
        'Tipo ordine test', '3654', TIMESTAMP '2014-03-07 16:07:42.423', 'nino');

INSERT INTO mandatekind (idmankind, active, ct, cu, description, header, lt, lu)
VALUES ('PROVA', NULL, TIMESTAMP '2007-11-06 13:53:55.933', 'NINO',
        'prova', 'prova', TIMESTAMP '2014-03-07 16:07:20.283', 'nino');

-- Fine generazione script

-- Creazione vista mandateview
CREATE OR REPLACE VIEW mandateview AS
